...
export default function ProfileFollowers({ profile, users }: Props) {
    return (
        <>
            <Head title={`Followers · @${profile.username}`} />
            <div className="flex flex-col gap-3">
                <div className="px-1">
                    ...
                    <h1 className="mt-2 text-lg font-semibold">Followers</h1>
                </div>
